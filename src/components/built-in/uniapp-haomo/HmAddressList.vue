  ...
  <view class="HmAddressList">
    ...
    >
      ...
      <view class="tui-content__box">
        <view
          class="tui-item__select"
          v-for="(item, index) in listData"
          :key="index"
        >
          <view
            v-if="index == listItemCur"
            class="tui-content__title"
            :class="{
              'tui-line__top': topLine,
              'tui-line__bottom': bottomLine,
            }"
          >
            <view
              class="tui-title__item"
              :style="{
                background: background_cur,
                color: color_cur,
                fontSize: size,
                height: height,
                padding: padding,
          ...
          <slot name="item" :entity="item.data" :index="index">
            <view v-for="(content, index) in item.data" :key="index">
              <view class="flex-row">
    ...
    <view
      class="tui-index__indicator"
      :class="[
        touching && indicatorTop != -1 ? 'tui-indicator__show' : '',
        treeKeyTran ? 'tui-indicator__tran' : '',
      ]"
    ...
    <view
      id="tui_index__letter"
      class="tui-index__letter"
    ...
    >
      <view
        class="tui-letter__item"
        :class="[index === treeItemCur ? 'tui-letter__cur' : '']"
        v-for="(item, index) in listData"
        :key="index"
        @tap="letterClick(index, item.letter)"
      >
        <view
          class="tui-letter__key"
          :style="{
            background: index === treeItemCur ? activeKeyBackground : '',
            color: index === treeItemCur ? activeKeyColor : keyColor,
          }"
        >
          {{ item.letter }}
        </view>
  ...
  methods: {
    ...
    initDom() {
      ...
      let remScale = (windowWidth || 375) / 375,
        ...
        backgroundColors = ColorUtil.gradient(
