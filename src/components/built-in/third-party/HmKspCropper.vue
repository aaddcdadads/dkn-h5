...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      this.rotate = 0;
      var rate = this.tailorWidth / this.tailorHeight;
    ...
    computeMatrix() {
      var width = this.tailorWidth;
      var height = this.tailorHeight;
      ...
      var rate = width / height;
      if (width > this.tailormaxWidth) {
        width = this.tailormaxWidth;
        height = width / rate;
      }
      if (height > this.tailormaxHeight) {
        height = this.tailormaxHeight;
        width = height * rate;
      }
