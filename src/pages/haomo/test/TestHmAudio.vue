<template>
  <view class="luch-audio__warp">
    <view
      class="luch-audio__cover"
      :class="{ 'luch-audio--cover-bg': !poster }"
    >
      <image :src="poster" v-if="poster" class="luch-audio__cover-img"></image>
      <view
        class="luch-audio__play-btn"
        :class="{ 'luch-audio--btn-pause': videoIsPlay }"
        @click="handleBtnClick"
      ></view>
    </view>
    <view class="luch-audio__audio-con">
      <view class="luch-audio__audio-info">
        <text class="luch-audio__audio-title luch-audio--text-eill">{{
          name
        }}</text>
        <text class="luch-audio__audio-author luch-audio--text-eill">{{
          author
        }}</text>
      </view>
