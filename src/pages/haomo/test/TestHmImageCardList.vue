<template>
    <!-- 瀑布流 -->
    <hm-image-card-list class="test1" 
    showMode="waterfallFlow" 
    :imgsList="list"
    :listbgColor="color"
    :btextcolor="color1"
    :mtextcolor="color2">
    ...
    <!-- 单列 -->
    <hm-image-card-list class="test2" 
    showMode="singleColumn"
    :listbgColor="color"
    :imgsList="list"
    :btextcolor="color2"
    :mtextcolor="color1">
...
<script>
import HmImageCardList from "@/components/built-in/uniapp-haomo/HmImageCardList.vue";
export default {
    components: { HmImageCardList },
    data() {
        return {
            color:'#f1f2f3',
            color1:'#ff0000',
