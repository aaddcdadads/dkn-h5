<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-popup ref="viewPopup" v-model:show="viewPopup.show" width="300px" height="220px" border-radius="8px" :closeable="false" class="ele-viewPopup"> 
      ...
      <hm-uview-text text=" 用户登录" font-size="16px" class="ele-ff8c8f6d-abf3-4690-89dd-cab3e0f9c77f"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-phoneBox">
      <information-input-box ref="phoneBox" v-model:value="phoneBox.value" :left-src="phoneBox.leftSrc" right-src="" :show-code="false" placeholder=" 请填写报名手机号码" class="ele-phoneBox"> 
       
    </information-input-box>
    </view> 
            <view class="ele-wrapper ele-wrapper-viewInput">
      <information-input-box ref="viewInput" v-model:value="viewInput.value" :left-src="viewInput.leftSrc" placeholder=" 请填写手机验证码" class="ele-viewInput"> 
...
export default {
  ...
  this.viewPopup.show = false;
    ...
    onSureButtonClick () {
  uni.$u.route('https://stage.block-design.cn/edit-page/?pageId=1751895267671543809');
}
  }
};
</script>
