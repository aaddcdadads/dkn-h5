<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-field :value="item.value" :label="item. label" :placeholder="item. placeholder" label-width="160" :label-align="'center'" icon="" right-icon="" :disabled="true" class="ele-21c5606d-d727-4143-a4ce-026bb85006c1"> 
    </hm-uview-field>
    </view> 
          </template> 
    </hm-loop>
      ...
      <hm-uview-bg-card ref="orderCard" width="100%" height="100%" padding="" box-shadow-color="#00000000" class="ele-orderCard"> 
            <view class="ele-wrapper ele-wrapper-746112cc-5e08-4544-b7c2-3063828fb42e">
      <hm-uview-field value="" label="订单编号" placeholder="" label-width="160" :label-align="'center'" icon="" right-icon="" :border-bottom="false" :disabled="true" class="ele-746112cc-5e08-4544-b7c2-3063828fb42e"> 
    </hm-uview-field>
    </view> 
            <view class="ele-wrapper ele-wrapper-56983658-9328-4199-9010-a825c2e59a41">
      <hm-uview-button :size="'mini'" class="ele-56983658-9328-4199-9010-a825c2e59a41"> 
      ...
      <hm-uview-field ref="orderCode" v-model:value="orderCode.value" label="订单编号" placeholder="" label-width="160" :label-align="'center'" icon="" right-icon="" :disabled="true" class="ele-orderCode"> 
    </hm-uview-field>
    </view> 
    </hm-uview-bg-card>
    </view> 
