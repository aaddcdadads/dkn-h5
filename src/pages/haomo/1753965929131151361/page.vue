<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-field value="" label="订单编号" placeholder="" label-width="160" :label-align="'center'" icon="" right-icon="" :disabled="true" class="ele-746112cc-5e08-4544-b7c2-3063828fb42e"> 
    </hm-uview-field>
    </view> 
