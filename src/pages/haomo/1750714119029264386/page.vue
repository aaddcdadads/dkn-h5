<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <activity-list ref="activityList" class="ele-activityList"> 
      ...
      <prize-list-component ref="activityImgList" :func-list="activityImgList.funcList" class="ele-activityImgList"> 
      ...
      <hm-uview-popup ref="regularPopup" v-model:show="regularPopup.show" :mode="'bottom'" width="100%" height="1000" :close-icon-pos="'top-left'" class="ele-regularPopup"> 
            <view class="ele-wrapper ele-wrapper-63de2731-6d75-42cd-bd28-d99b529b8759">
      <hm-uview-parse :data='{"html":"<h2 style=\"text-align: center;\">活动规则</h2><p style=\"text-align: left;\">玩法介绍</p><p>第一步 报名</p><p> 点击页面下方的「马上报名」，选择自己要挑战的公里数。</p><p>-- 选择公里数对应的奖牌套餐，提交订单支付并填写收件信息即可在完赛后获得奖牌/奖牌配件/周边。</p><p>第二步 比赛</p><p>在比赛时间内，打开 Keep，一次性跑完您挑战的公里数即可。</p><p>-- 户外/跑步机皆可。</p><p>奖牌及奖牌配件/周边将在完赛后 30 个工作日内发货；</p><p style=\"color: red;\">请注意！！若未完赛，则奖牌将无法发出，但配件/周边仍可以在活动结束后发货；（30 个工作日从完赛后第一个工作日开始计算）</p>"}' :show-height="0" class="ele-63de2731-6d75-42cd-bd28-d99b529b8759"> 
      ...
      <hm-uview-bg-card width="100%" height="" border-radius="0" :text-align="'center'" padding="0" box-shadow-color="#00000000" background-color="#FFE8EC00" class="ele-ea66b462-b5ce-4b41-8870-bb482768fef8"> 
            <view class="ele-wrapper ele-wrapper-ff8c8f6d-abf3-4690-89dd-cab3e0f9c77f">
      <hm-uview-text text="用户登录查看报名信息" font-size="16px" class="ele-ff8c8f6d-abf3-4690-89dd-cab3e0f9c77f"> 
      ...
      <information-input-box ref="viewInput" v-model:value="viewInput.value" placeholder=" 请填写手机验证码" class="ele-viewInput"> 
