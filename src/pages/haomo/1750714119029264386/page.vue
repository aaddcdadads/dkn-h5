<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-text padding="0" color="#000000" font-size="16px" text="活动奖品" bg-color="#FFFFFF00" class="ele-76b3694d-443e-4d62-8c58-80e0356f7fa4"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-5799ec0b-0d4b-4bc5-9774-6a2ba9417af5">
      <hm-uview-bg-card padding="0" border-radius="12" background-color="#F797BD00" width="100%" height="" class="ele-5799ec0b-0d4b-4bc5-9774-6a2ba9417af5"> 
      ...
      <prize-list-component ref="activityImgList" :func-list="activityImgList.funcList" :style="activityImgList.style" :background-color="activityImgList.backgroundColor" :text-color="activityImgList.textColor" class="ele-activityImgList"> 
      ...
      <hm-uview-text color="#000000" font-size="16px" text="活动详情" bg-color="#FFFFFF00" class="ele-dacbdcbf-5aa6-416f-a334-d9098c8ccfda"> 
      ...
      <hm-rich-text :nodes='[{"name":"div","attrs":{"class":"div-class","style":"line-height: 40px; color: #000; text-align:left;"},"children":[{"type":"text","text":"第一步 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;报名点击页面下方的「马上报名」，选择自己要挑战的公里数。-- 选择公里数对应的奖牌套餐，提交订单支付并填写收件信息即可在完赛后获得奖牌/奖牌配件/周边。第二步 比赛在比赛时间内，打开 Keep，一次性跑完您挑战的公里数即可。-- 户外/跑步机皆可。奖牌及奖牌配件/周边将在完赛后 30 个工作日内发货；请注意！！若未完赛，则奖牌将无法发出，但配件/周边仍可以在活动结束后发货；（30 个工作日从完赛后第一个工作日开始计算）"}]}]' class="ele-720c2355-c756-4d18-9400-34ab42449b92"> 
      ...
      <information-input-box ref="phoneBox" v-model:value="phoneBox.value" right-src="" :show-code="false" placeholder=" 请填写报名手机号码" class="ele-phoneBox"> 
       
    </information-input-box>
    </view> 
            <view class="ele-wrapper ele-wrapper-viewInput">
      <information-input-box ref="viewInput" v-model:value="viewInput.value" placeholder=" 请填写手机验证码" @onCode="onViewInputOnCode" class="ele-viewInput"> 
      ...
      <hm-uview-bg-card width="100%" height="" border-radius="0" :text-align="'center'" padding="0" box-shadow-color="#00000000" background-color="#FFE8EC00" class="ele-c43ff619-898c-4446-a22f-6dc191e8ac6e"> 
      ...
      <hm-uview-bg-card width="100%" height="" border-radius="0" :text-align="'center'" padding="0" box-shadow-color="#00000000" background-color="#FFE8EC00" class="ele-22dc02bc-b7b8-4d6b-83d6-6ee319d12809"> 
      ...
      <hm-uview-bg-card width="100%" height="" border-radius="0" :text-align="'center'" padding="0" box-shadow-color="#00000000" background-color="#FFE8EC00" class="ele-6bf03fb4-83a2-441f-866a-b1bed62d2f12"> 
            <view class="ele-wrapper ele-wrapper-canelButton">
      <hm-uview-button ref="canelButton" :type="canelButton.type" :text="canelButton.text" @click="onCanelButtonClick" class="ele-canelButton"> 
...
.ele-wrapper-76b3694d-443e-4d62-8c58-80e0356f7fa4 {
  float:left;
margin-top:24rpx;    font-weight: bolder;margin-bottom:12rpx;
}
...
.ele-wrapper-dacbdcbf-5aa6-416f-a334-d9098c8ccfda {
  float:left;
margin-top:12px;    font-weight: bolder;margin-bottom:12rpx;
}
