  ...
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-text font-size="16px" text="活动规则" class="ele-dc91ed40-34d2-458d-a7fb-c67671b736c2"> 
            ...
            <view class="ele-wrapper ele-wrapper-63de2731-6d75-42cd-bd28-d99b529b8759">
      <hm-uview-parse :data='{"html":"<p style=\"text-align: left;\">第一步 报名</p><p style=\"text-align: left;\">点击页面下方的「马上报名」，选择自己要挑战的公里数。</h2><p>-- 选择公里数对应的奖牌套餐，提交订单支付并填写收件信息即可在完赛后获得奖牌/奖牌配件/周边。</p><p> 第二步 比赛</p><p>在比赛时间内，打开 Keep，一次性跑完您挑战的公里数即可。</p><p>-- 户外/跑步机皆可。</p><p>奖牌及奖牌配件/周边将在完赛后 30 个工作日内发货；</p><p  style=\"color: red;\">请注意！！若未完赛，则奖牌将无法发出，但配件/周边仍可以在活动结束后发货；（30 个工作日从完赛后第一个工作日开始计算）</p>"}' :show-height="0"> 
      ...
      <hm-uview-popup ref="viewPopup" v-model:show="viewPopup.show" border-radius="8px" :closeable="false" width="80%" height="220px" @open="onViewPopupOpen" class="ele-viewPopup"> 
      ...
      <hm-uview-popup ref="phonePopup" v-model:show="phonePopup.show" width="80%" height="180px" border-radius="8px" :closeable="false" class="ele-phonePopup"> 
      ...
      <hm-uview-text font-size="16px" text="活动咨询电话"> 
            ...
            <view class="ele-wrapper ele-wrapper-bff77688-bc73-4049-8b13-351754f30171">
      <hm-uview-text text="400-888-88888" class="ele-bff77688-bc73-4049-8b13-351754f30171"> 
      ...
      <hm-uview-bg-card width="100%" height="" border-radius="0" padding="0" box-shadow-v-shadow="0" box-shadow-blur="0" box-shadow-color="#00000000" background-color="#FFFFFF00" class="ele-a5b9bd79-5420-4a89-a71c-7e1c4870ca1a"> 
