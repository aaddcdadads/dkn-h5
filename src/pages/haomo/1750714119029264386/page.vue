<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-bg-card width="100%" height="" border-radius="0" padding="12" box-shadow-v-shadow="0" box-shadow-blur="0" box-shadow-color="#00000000" background-color="#FFFFFF00" class="ele-a5b9bd79-5420-4a89-a71c-7e1c4870ca1a"> 
            <view class="ele-wrapper ele-wrapper-8f33b075-7117-49ed-bd18-640aa28fa939">
      <hm-uview-icon name="iphone" color="#FFFFFF" size="20px" label="活动咨询" label-color="#FFFFFF" class="ele-8f33b075-7117-49ed-bd18-640aa28fa939"> 
