...
export default {
 ...
 console.log(1)
  ...
  uni.$u.route('https://stage.block-design.cn/edit-page/?pageId=1752601339138936834');
},
  ...
  uni.$u.route(`/pages/haomo/1750444738487521281/page?activityId=${this.activityId}`);
