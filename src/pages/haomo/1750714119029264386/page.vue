<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-button ref="canel1Button" :type="canel1Button.type" :text="canel1Button.text" @click="onCanel1ButtonClick" class="ele-canel1Button"> 
       
    </hm-uview-button>
    </view> 
            <view class="ele-wrapper ele-wrapper-sure1Button">
      <hm-uview-button ref="sure1Button" :type="sure1Button.type" :text="sure1Button.text" @click="onSure1ButtonClick" class="ele-sure1Button"> 
