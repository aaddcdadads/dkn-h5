<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-text ref="nameText" :text="nameText.text" :font-size="nameText.fontSize" :padding="nameText.padding" class="ele-nameText"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-80a0f605-13bf-4742-904d-a7c8cdce9da1">
      <hm-uview-text text="迪卡侬线上骑行活动" font-size="16px" color="#FFFFFF" padding="0" class="ele-80a0f605-13bf-4742-904d-a7c8cdce9da1"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-07beb51b-0feb-440f-9824-a723c709c3ce">
      <hm-uview-text text="报名倒计时" font-size="14px" color="#FFFFFF" padding="0" class="ele-07beb51b-0feb-440f-9824-a723c709c3ce"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-closeTime">
      <uni-countdown ref="closeTime" :background-color="closeTime.backgroundColor" :color="closeTime.color" :font-size="closeTime.fontSize" :splitor-color="closeTime.splitorColor" :day="closeTime.day" :hour="closeTime.hour" :minute="closeTime.minute" :second="closeTime.second" class="ele-closeTime"> 
      ...
      <hm-uview-bg-card ref="activityBg" :width="activityBg.width" :height="activityBg.height" :border-radius="activityBg.borderRadius" :padding="activityBg.padding" :background-color="activityBg.backgroundColor" class="ele-activityBg"> 
      ...
      <hm-uview-text padding="0" color="#FFFFFF" font-size="12px" text="Keep ·HelloKitty系列" class="ele-ad039bb7-8f55-4ab8-98a8-54d1f73db365"> 
      ...
      <hm-uview-text padding="6" color="#FFFFFF99" font-size="10px" text="线上马拉松" class="ele-f0bdc2b0-8112-4546-8c75-84df79598453"> 
      ...
      <hm-uview-text ref="imgText" :text="imgText.text" :font-size="imgText.fontSize" :color="imgText.color" :bg-color="imgText.bgColor" :padding="imgText.padding" class="ele-imgText"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-imgCard">
      <hm-uview-bg-card ref="imgCard" :width="imgCard.width" :height="imgCard.height" :border-radius="imgCard.borderRadius" :padding="imgCard.padding" :background-color="imgCard.backgroundColor" :hidden="imgCard.hidden" class="ele-imgCard"> 
      ...
      <scroll-list ref="activityImgList" :func-list="activityImgList.funcList" :background-color="activityImgList.backgroundColor" :text-color="activityImgList.textColor"> 
      ...
      <hm-uview-text text="活动详情" font-size="16px" color="#FFFFFF" bg-color="#FFFFFF00" class="ele-dacbdcbf-5aa6-416f-a334-d9098c8ccfda"> 
      ...
      <prize-list-component ref="listCompanent" :func-list="listCompanent.funcList" :style="listCompanent.style" :background-color="listCompanent.backgroundColor" :text-color="listCompanent.textColor" class="ele-listCompanent"> 
      ...
      <hm-uview-bg-card width="100%" height="" :text-align="'center'" padding="0" box-shadow-v-shadow="0" box-shadow-blur="0" box-shadow-color="#00000000" background-color="#FFFFFF00" class="ele-09caddfa-4979-48b3-81fd-a043baa3c683"> 
            <view class="ele-wrapper ele-wrapper-228650bd-8f5f-4f58-b322-de6b1040aba7">
      <hm-uview-icon name="server-fill" color="#E06994" size="20px" label="活动咨询" label-color="#E06994" @click="onEle228650Bd8F5F4F58B322De6B1040Aba7Click" class="ele-228650bd-8f5f-4f58-b322-de6b1040aba7"> 
       
    </hm-uview-icon>
    </view> 
            <view class="ele-wrapper ele-wrapper-a40489b1-523c-497a-8587-70b09de8a231">
      <hm-uview-icon name="zhuanfa" color="#E06994" size="20px" label="分享" label-color="#E06994" @click="onElea40489B1523C497A858770B09De8A231Click" class="ele-a40489b1-523c-497a-8587-70b09de8a231"> 
      ...
      <hm-uview-bg-card ref="phoneBg" width="100%" height="" border-radius="0" padding="0" box-shadow-v-shadow="0" box-shadow-blur="0" box-shadow-color="#00000000" background-color="#FFFFFF" class="ele-phoneBg"> 
            <view class="ele-wrapper ele-wrapper-f16cae12-ff6f-4d64-ac60-014a613da044">
      <hm-uview-icon name="phone" color="#FFFFFF" size="20px" label="活动咨询" label-color="#FFFFFF" @click="onElef16Cae12Ff6F4D64Ac60014A613Da044Click" class="ele-f16cae12-ff6f-4d64-ac60-014a613da044"> 
      ...
      <hm-uview-text font-size="16px" text="活动规则" class="ele-dc91ed40-34d2-458d-a7fb-c67671b736c2"> 
      ...
      <hm-uview-parse ref="activityRulesText" :data="activityRulesText.data" :show-height="activityRulesText.showHeight"> 
      ...
      <hm-uview-popup ref="viewPopup" v-model:show="viewPopup.show" width="300px" height="220px" border-radius="8px" :closeable="false" @open="onViewPopupOpen" class="ele-viewPopup"> 
      ...
      <hm-uview-text font-size="16px" text="用户登录查看报名信息" class="ele-ff8c8f6d-abf3-4690-89dd-cab3e0f9c77f"> 
      ...
      <information-input-box ref="viewInput" placeholder=" 请填写手机验证码" v-model:value="viewInput.value" @onCode="onViewInputOnCode" class="ele-viewInput"> 
      ...
      <hm-uview-button ref="canel1Button" :text="canel1Button.text" :type="canel1Button.type" @click="onCanel1ButtonClick" class="ele-canel1Button"> 
       
    </hm-uview-button>
    </view> 
            <view class="ele-wrapper ele-wrapper-sure1Button">
      <hm-uview-button ref="sure1Button" :text="sure1Button.text" :type="sure1Button.type" @click="onSure1ButtonClick" class="ele-sure1Button"> 
      ...
      <hm-uview-popup ref="phonePopup" v-model:show="phonePopup.show" width="80%" height="164px" border-radius="8px" :closeable="false" class="ele-phonePopup"> 
      ...
      <hm-uview-text ref="phoneText" :text="phoneText.text" class="ele-phoneText"> 
      ...
      <hm-uview-button ref="canelButton" :text="canelButton.text" :type="canelButton.type" @click="onCanelButtonClick" class="ele-canelButton"> 
       
    </hm-uview-button>
    </view> 
            <view class="ele-wrapper ele-wrapper-sureButton">
      <hm-uview-button ref="sureButton" :text="sureButton.text" :type="sureButton.type" @click="onSureButtonClick" class="ele-sureButton"> 
      ...
      <hm-uview-radio ref="isProtocol" v-model:value="isProtocol.value" title="" :list="isProtocol.list" class="ele-isProtocol"> 
       
    </hm-uview-radio>
    </view> 
            <view class="ele-wrapper ele-wrapper-7a55d0c9-95ac-4729-befd-31f60ecf4707">
      <hm-uview-text text="《活动报名用户协议及承诺书》" font-size="14px" color="#D6769C" :text-align="'left'" padding="0" @onClick="onEle7A55D0C995Ac4729Befd31F60Ecf4707OnClick" class="ele-7a55d0c9-95ac-4729-befd-31f60ecf4707"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-e174c2e6-a799-4ccf-8fa9-2a81dc515a6f">
      <hm-uview-button :type="'success'" text="马上报名" @click="onElee174C2E6A7994Ccf8Fa92A81Dc515A6FClick" class="ele-e174c2e6-a799-4ccf-8fa9-2a81dc515a6f"> 
       
    </hm-uview-button>
    </view> 
            <view class="ele-wrapper ele-wrapper-4d8eb71c-1539-4984-8ba0-e2dd0e6ceeb9">
      <hm-uview-text text="已报名，查看我的报名信息" font-size="14px" color="#D6769C" @onClick="onEle4D8Eb71C153949848Ba0E2Dd0E6Ceeb9OnClick" class="ele-4d8eb71c-1539-4984-8ba0-e2dd0e6ceeb9"> 
