<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-bg-card ref="outsideBg" padding="0" box-shadow-color="#00000000" border-radius="0" background-color="#FFE8EC" width="100%" height="" class="ele-outsideBg"> 
      ...
      <hm-uview-bg-card padding="0" box-shadow-color="#00000000" border-radius="0" width="100%" height="" class="ele-2bcd93f6-265c-4f8d-83ec-744c2f6d40e2"> 
      ...
      <uni-countdown background-color="#00000000" color="#FFFFFF" :hour="15" splitor-color="#666666" :font-size="11" :day="19" :minute="13" :second="17" class="ele-4f853c6d-0b81-4d35-8ce5-ac7316260eae"> 
      ...
      <activity-list ref="activityList" :background-color="activityList.backgroundColor" :item="activityList.item" :text-color="activityList.textColor" class="ele-activityList"> 
      ...
      <prize-list-component ref="activityImgList" :func-list="activityImgList.funcList" :background-color="activityImgList.backgroundColor" :style="activityImgList.style" class="ele-activityImgList"> 
      ...
      <hm-uview-bg-card padding="0" box-shadow-blur="0" box-shadow-v-shadow="0" box-shadow-color="#00000000" border-radius="12" background-color="#F797BD00" width="100%" height="400" class="ele-0d696b7e-8100-4e0a-a949-9e8788ae1cec"> 
    </hm-uview-bg-card>
    </view> 
            <view class="ele-wrapper ele-wrapper-9bb5842b-b006-40fa-a5a0-9c71da20a550">
      <hm-uview-bg-card padding="12" border-radius="12" background-color="#F797BD" width="100%" height="" class="ele-9bb5842b-b006-40fa-a5a0-9c71da20a550"> 
            <view class="ele-wrapper ele-wrapper-5ffca98b-a826-46e6-a408-cf1165d243d2">
      <hm-cell-list :is-border="false" width="100%" :list='[{"date":"+ 加入","image":"https://img2.baidu.com/it/u=3886895525,3764775842&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500","descrip":"65484成员","id":"1","title":"Keep 三丽鸥家族"}]' bg-color="#FFFFFF00" height="60" class="ele-5ffca98b-a826-46e6-a408-cf1165d243d2"> 
      ...
      <hm-rich-text :nodes='[{"name":"div","attrs":{"class":"div-class","style":"line-height: 60px; color: red; text-align:center;"},"children":[{"type":"text","text":"第一步 报名</p><p style=\"text-align: left;\">点击页面下方的「马上报名」，选择自己要挑战的公里数。</h2><p>-- 选择公里数对应的奖牌套餐，提交订单支付并填写收件信息即可在完赛后获得奖牌/奖牌配件/周边。</p><p> 第二步 比赛</p><p>在比赛时间内，打开 Keep，一次性跑完您挑战的公里数即可。</p><p>-- 户外/跑步机皆可。</p><p>奖牌及奖牌配件/周边将在完赛后 30 个工作日内发货；</p><p  style=\"color: red;\">请注意！！若未完赛，则奖牌将无法发出，但配件/周边仍可以在活动结束后发货；（30 个工作日从完赛后第一个工作日开始计算）"}]}]'> 
      ...
      <hm-uview-popup ref="viewPopup" v-model:show="viewPopup.show" width="80%" height="220px" border-radius="8px" :closeable="false" @open="onViewPopupOpen" class="ele-viewPopup"> 
      ...
      <hm-uview-bg-card width="100%" height="" border-radius="0" :text-align="'center'" padding="0" box-shadow-color="#00000000" background-color="#FFE8EC00" class="ele-6bf03fb4-83a2-441f-866a-b1bed62d2f12"> 
            <view class="ele-wrapper ele-wrapper-canelButton">
      <hm-uview-button ref="canelButton" :text="canelButton.text" :type="canelButton.type" class="ele-canelButton"> 
       
    </hm-uview-button>
    </view> 
            <view class="ele-wrapper ele-wrapper-sureButton">
      <hm-uview-button ref="sureButton" :text="sureButton.text" :type="sureButton.type" class="ele-sureButton"> 
      ...
      <hm-uview-bg-card padding="12" box-shadow-color="#00000000" border-radius="0" width="100%" height="" class="ele-2136b833-7f0e-4a8a-a081-36d9e275f611"> 
            <view class="ele-wrapper ele-wrapper-a5b9bd79-5420-4a89-a71c-7e1c4870ca1a">
      <hm-uview-bg-card padding="0" box-shadow-blur="0" box-shadow-v-shadow="0" box-shadow-color="#00000000" border-radius="0" background-color="#FFFFFF00" width="100%" height="" class="ele-a5b9bd79-5420-4a89-a71c-7e1c4870ca1a"> 
            <view class="ele-wrapper ele-wrapper-8f33b075-7117-49ed-bd18-640aa28fa939">
      <hm-uview-icon name="phone" color="#FFFFFF" size="20px" label="活动咨询" label-color="#FFFFFF" @click="onEle8F33B075711749EdBd18640Aa28Fa939Click" class="ele-8f33b075-7117-49ed-bd18-640aa28fa939"> 
...
export default {
 ...
 console.log(1)
  ...
  uni.$u.route(`/pages/haomo/1750444738487521281/page?activityId=${self.activityId}`);
...
.ele-wrapper-colourCard {
  width:100%;
position:absolute;
margin-top:-48rpx;    border-radius: 20px 20px 0px 0px;
/deep/.hm-bg-card{
