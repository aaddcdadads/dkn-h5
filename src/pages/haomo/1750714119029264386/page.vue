<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-popup ref="phonePopup" v-model:show="phonePopup.show" border-radius="8px" :closeable="false" width="80%" height="180px" class="ele-phonePopup"> 
      ...
      <hm-uview-icon label-color="#FFFFFF" color="#FFFFFF" size="20px" name="phone" label="活动咨询" @click="onEle8F33B075711749EdBd18640Aa28Fa939Click" class="ele-8f33b075-7117-49ed-bd18-640aa28fa939"> 
