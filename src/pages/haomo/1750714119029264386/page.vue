<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-bg-card ref="colourCard" width="100%" height="" border-radius="0" padding="12" box-shadow-color="#00000000" background-color="#F6D7E6" class="ele-colourCard"> 
      ...
      <activity-list ref="activityList" :item="activityList.item" class="ele-activityList"> 
      ...
      <prize-list-component ref="activityImgList" :func-list="activityImgList.funcList" :style="activityImgList.style" class="ele-activityImgList"> 
