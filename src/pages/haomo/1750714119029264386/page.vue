<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-bg-card ref="colourCard" :width="colourCard.width" :height="colourCard.height" :border-radius="colourCard.borderRadius" :padding="colourCard.padding" :box-shadow-color="colourCard.boxShadowColor" :background-color="colourCard.backgroundColor" class="ele-colourCard"> 
