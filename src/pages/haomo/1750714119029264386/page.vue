<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-bg-card ref="outsideBg" :padding="outsideBg.padding" :hidden="outsideBg.hidden" :box-shadow-color="outsideBg.boxShadowColor" :border-radius="outsideBg.borderRadius" :background-color="outsideBg.backgroundColor" :width="outsideBg.width" :height="outsideBg.height" class="ele-outsideBg"> 
      ...
      <hm-uview-text text="迪卡侬春节活动" font-size="16px" padding="0" class="ele-80a0f605-13bf-4742-904d-a7c8cdce9da1"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-07beb51b-0feb-440f-9824-a723c709c3ce">
      <hm-uview-text text="报名倒计时" font-size="14px" color="#666666" padding="0" class="ele-07beb51b-0feb-440f-9824-a723c709c3ce"> 
      ...
      <hm-uview-bg-card ref="imgCard" width="100%" height="" border-radius="12" padding="" background-color="#F797BD00" class="ele-imgCard"> 
