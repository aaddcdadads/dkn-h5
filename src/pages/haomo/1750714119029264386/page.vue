<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <prize-list-component ref="activityImgList" :func-list="activityImgList.funcList" :style="activityImgList.style" :background-color="activityImgList.backgroundColor" class="ele-activityImgList"> 
