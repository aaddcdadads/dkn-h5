<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-text text="报名倒计时" font-size="14px" color="#000000" padding="0" class="ele-07beb51b-0feb-440f-9824-a723c709c3ce"> 
      ...
      <hm-uview-popup ref="regularPopupp" v-model:show="regularPopupp.show" :mode="'bottom'" width="100%" height="450px" :close-icon-pos="'top-left'" class="ele-regularPopupp"> 
            <view class="ele-wrapper ele-wrapper-dc91ed40-34d2-458d-a7fb-c67671b736c2">
      <hm-uview-text text="活动规则" font-size="16px" class="ele-dc91ed40-34d2-458d-a7fb-c67671b736c2"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-activityRulesText1">
      <hm-uview-parse ref="activityRulesText1" :data="activityRulesText1.data" :show-height="activityRulesText1.showHeight" class="ele-activityRulesText1"> 
      ...
      <hm-uview-button ref="sureButton" :type="sureButton.type" :text="sureButton.text" @click="onSureButtonClick" class="ele-sureButton"> 
      ...
      <hm-uview-popup ref="regularPopup" v-model:show="regularPopup.show" :mode="'bottom'" width="100%" height="450px" :close-icon-pos="'top-left'" class="ele-regularPopup"> 
            <view class="ele-wrapper ele-wrapper-4c8afa9c-0775-4fb5-8f59-2cd7f7534f46">
      <hm-uview-text text="活动规则" font-size="16px" class="ele-4c8afa9c-0775-4fb5-8f59-2cd7f7534f46"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-activityRulesText">
      <hm-uview-parse ref="activityRulesText" :data="activityRulesText.data" :show-height="activityRulesText.showHeight" class="ele-activityRulesText"> 
