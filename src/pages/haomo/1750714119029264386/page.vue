<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-bg-card ref="notActivity" :width="notActivity.width" :height="notActivity.height" :border-radius="notActivity.borderRadius" :padding="notActivity.padding" :box-shadow-color="notActivity.boxShadowColor" :background-color="notActivity.backgroundColor" :hidden="notActivity.hidden" class="ele-notActivity"> 
