<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-icon name="question-circle" color="#FFFFFF" size="20px" label="规则" label-color="#FFFFFF" class="ele-0abf4877-51bc-431d-8f1a-3c043bc451fe"> 
      ...
      <hm-cell-list width="100%" height="60" :is-border="false" bg-color="#FFFFFF00" :list='[{"id":"1","title":"Keep 三丽鸥家族","descrip":"65484成员","date":"+ 加入","image":"https://img2.baidu.com/it/u=3886895525,3764775842&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500"}]' class="ele-5ffca98b-a826-46e6-a408-cf1165d243d2"> 
            ...
            <view class="ele-wrapper ele-wrapper-8c006472-eabd-41ce-9098-c1e883253807">
      <hm-uview-popup :show="true" :mode="'bottom'" width="100%" height="30%" :close-icon-pos="'top-left'" class="ele-8c006472-eabd-41ce-9098-c1e883253807"> 
