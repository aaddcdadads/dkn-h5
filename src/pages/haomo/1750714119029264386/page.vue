<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-bg-card ref="outsideBg" width="100%" height="" border-radius="0" padding="0" box-shadow-color="#00000000" class="ele-outsideBg"> 
      ...
      <hm-uview-cell-list :list='[{"key":1,"title":"左侧标题","icon":"setting-fill","required":true,"borderTop":false,"borderBottom":true,"label":"标题下方的描述信息","value":""},{"key":2,"title":"左侧标题","icon":"setting-fill","required":false,"borderTop":false,"borderBottom":false,"label":"","value":"右侧内容"}]' :arrow="true" class="ele-785b238a-f724-409d-9297-30f00dff9cca"> 
