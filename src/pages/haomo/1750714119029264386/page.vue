  ...
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-bg-card ref="imageBg" width="100%" height="" border-radius="0" padding="0" box-shadow-v-shadow="0" box-shadow-color="#00000000" background-color="#FFFFFF00" class="ele-imageBg"> 
            <view class="ele-wrapper ele-wrapper-f91b4645-a50f-4879-857d-46279f610ca8">
      <hm-uview-image src="https://static1.keepcdn.com/teyvat-cms/2023/10/24/1698136514335c25agsam_750x1000.jpg" width="100%" height="500px" class="ele-f91b4645-a50f-4879-857d-46279f610ca8"> 
      ...
      <hm-uview-bg-card ref="videoBg" width="100%" height="" border-radius="0" padding="0" box-shadow-v-shadow="0" box-shadow-blur="0" box-shadow-color="#00000000" background-color="#FFFFFF00" :hidden="true" class="ele-videoBg"> 
            <view class="ele-wrapper ele-wrapper-438459e7-727d-4437-a364-b6eb07613382">
      <video class="ele-438459e7-727d-4437-a364-b6eb07613382"> 
    </video>
    </view> 
    </hm-uview-bg-card>
    </view> 
      ...
      <hm-uview-bg-card width="100%" height="" border-radius="0" padding="12" box-shadow-color="#00000000" background-color="#FFE8EC" class="ele-2966337e-38af-4573-a9c7-464b04d48566"> 
            <view class="ele-wrapper ele-wrapper-c2db3fcd-05d0-472b-8e18-163c243cc425">
      <hm-uview-bg-card width="100%" height="" border-radius="12" padding="12" background-color="#F797BD" class="ele-c2db3fcd-05d0-472b-8e18-163c243cc425"> 
            <view class="ele-wrapper ele-wrapper-6ba2b397-6caf-44b2-8d16-4ad0c0eba375">
      <hm-uview-bg-card width="100%" height="" border-radius="0" :text-align="'right'" padding="0" box-shadow-v-shadow="0" box-shadow-blur="0" box-shadow-color="#00000000" background-color="#FFFFFF00" class="ele-6ba2b397-6caf-44b2-8d16-4ad0c0eba375"> 
            <view class="ele-wrapper ele-wrapper-a45a5040-24f2-43f3-8f5a-6b9d497eb002">
      <hm-uview-text text="报名仅剩" font-size="11px" color="#FFFFFF"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-0b526546-fffe-44d9-8fc9-6ed8ddc24c72">
      <uni-countdown background-color="#00000000" color="#FFFFFF" :font-size="11" splitor-color="#FFFFFF" :day="19" :hour="15" :minute="13" :second="17"> 
      ...
      <hm-uview-text text="Keep ·HelloKitty系列" font-size="10px" color="#FFFFFF" padding="0" class="ele-ad039bb7-8f55-4ab8-98a8-54d1f73db365"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-f1b5f026-f12a-46a9-b78f-dea0efd75a30">
      <hm-uview-icon name="arrow-right" color="#FFFFFF" size="10px" label="" label-color="#FFFFFF" class="ele-f1b5f026-f12a-46a9-b78f-dea0efd75a30"> 
       
    </hm-uview-icon>
    </view> 
    </hm-uview-bg-card>
    </view> 
            <view class="ele-wrapper ele-wrapper-68028b41-e565-41ca-94f3-03281e4d4c4f">
      <hm-uview-text text="派对甜心｜HelloKitty生日主题线上跑" color="#FFFFFF" :text-align="'left'" class="ele-68028b41-e565-41ca-94f3-03281e4d4c4f"> 
      ...
      <hm-uview-text text="线上马拉松" font-size="10px" color="#FFFFFF" padding="6" class="ele-f0bdc2b0-8112-4546-8c75-84df79598453"> 
       
    </hm-uview-text>
    </view> 
    </hm-uview-bg-card>
    </view> 
            <view class="ele-wrapper ele-wrapper-785b238a-f724-409d-9297-30f00dff9cca">
      <hm-uview-cell-list :list='[{"key":1,"title":"活动时间 2023.11.01 00:00-2024.02.15 23:59","icon":"calendar","required":false,"borderTop":false,"borderBottom":false,"label":"","value":""},{"key":2,"title":"1.314km/5.20km/9.99km","icon":"setting-fill","required":false,"borderTop":false,"borderBottom":false,"label":"","value":""},{"key":3,"title":"如何玩转","icon":"question-circle","required":false,"borderTop":false,"borderBottom":false,"label":"","value":""},{"key":4,"title":"已报名4646人","icon":"staff","required":false,"borderTop":false,"borderBottom":false,"label":"","value":""}]' :arrow="true" :icon-style='{"color":"#fff"}' :title-style='{"color":"#fff"}' class="ele-785b238a-f724-409d-9297-30f00dff9cca"> 
      ...
      <hm-uview-bg-card width="100%" height="" border-radius="12" padding="12" background-color="#F797BD" class="ele-5799ec0b-0d4b-4bc5-9774-6a2ba9417af5"> 
            <view class="ele-wrapper ele-wrapper-67658805-d92e-4e1f-8067-6a180eca6391">
      <hm-uview-bg-card width="100%" height="" border-radius="0" padding="0" box-shadow-color="#00000000" background-color="#FFFFFF00" class="ele-67658805-d92e-4e1f-8067-6a180eca6391"> 
            <view class="ele-wrapper ele-wrapper-b5a81ba4-33af-478f-bd93-1199f013e523">
      <hm-uview-text text="完赛奖品" font-size="12px" color="#FFFFFF" bg-color="#FFFFFF00" class="ele-b5a81ba4-33af-478f-bd93-1199f013e523"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-b5776b9e-5bb1-40f5-8854-f2b4dc696a41">
      <hm-uview-text text="未完赛将无法获得奖品" font-size="8px" color="#FFFFFF99" class="ele-b5776b9e-5bb1-40f5-8854-f2b4dc696a41"> 
      ...
      <hm-uview-text text="请注意！！若未完赛，则奖牌将无法发出，但配件/周边仍可以在活动结束后发货；（30 个工作日从完赛后第一个工作日开始计算）" font-size="12px" color="#E60000" :text-align="'left'" class="ele-30657b3a-defb-4229-91e7-6326e04c3af2"> 
            ...
            <view class="ele-wrapper ele-wrapper-bb2067ec-1955-48be-b696-2b8ddf0ca01d">
      <hm-uview-bg-card width="100%" height="" border-radius="0" padding="0" box-shadow-color="#00000000" class="ele-bb2067ec-1955-48be-b696-2b8ddf0ca01d"> 
            <view class="ele-wrapper ele-wrapper-14176f59-eadd-478d-b9a2-1e80a6793bfe">
      <hm-uview-button :type="'success'" text="马上报名" class="ele-14176f59-eadd-478d-b9a2-1e80a6793bfe"> 
      ...
      <hm-uview-bg-card width="100%" height="" border-radius="0" padding="0" box-shadow-color="#00000000" class="ele-2136b833-7f0e-4a8a-a081-36d9e275f611"> 
