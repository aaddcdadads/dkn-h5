<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-parse :data='{"html":"<h1 style=\"text-align: center;\">新闻</h1><h2 style=\"text-align: center;\">作者：胡小根</h2><p>这是正文。</p><p> 这是结尾。</p>"}' :show-height="0"> 
       
    </hm-uview-parse>
    </view> 
            <view class="ele-wrapper ele-wrapper-534e6687-3b1f-438f-936b-40c32eed0534">
      <hm-rich-text :nodes='[{"children":[{"text":"玩法介绍","type":"text"},{"text":"第一步 报名","type":"text"},{"text":"点击页面下方的「马上报名」，选择自己要挑战的公里数。","type":"text"},{"text":"-- 选择公里数对应的奖牌套餐，提交订单支付并填写收件信息即可在完赛后获得奖牌/奖牌配件/周边。","type":"text"},{"text":"第二步 比赛","type":"text"},{"text":"在比赛时间内，打开 Keep，一次性跑完您挑战的公里数即可。","type":"text"},{"text":"-- 户外/跑步机皆可。","type":"text"},{"text":"奖牌及奖牌配件/周边将在完赛后 30 个工作日内发货；","type":"text"}],"name":"div","attrs":{"style":"line-height: 40px; color: #000000; text-align:left;","class":"div-class"}}]' class="ele-534e6687-3b1f-438f-936b-40c32eed0534"> 
       
    </hm-rich-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-82757320-2908-4ea4-a4a6-d6a672339dab">
      <hm-uview-text font-size="12px" text="玩法介绍" class="ele-82757320-2908-4ea4-a4a6-d6a672339dab"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-f8b609db-e332-45a3-8489-fba690b76d97">
      <hm-uview-text font-size="12px" text="第一步 报名" class="ele-f8b609db-e332-45a3-8489-fba690b76d97"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-92d692d3-6c86-4408-8023-fbff541eef72">
      <hm-uview-text font-size="12px" text="点击页面下方的「马上报名」，选择自己要挑战的公里数。" :text-align="'left'" class="ele-92d692d3-6c86-4408-8023-fbff541eef72"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-1bc765de-b93e-4b9b-9419-38462cabd3e8">
      <hm-uview-text font-size="12px" text="-- 选择公里数对应的奖牌套餐，提交订单支付并填写收件信息即可在完赛后获得奖牌/奖牌配件/周边。" :text-align="'left'" class="ele-1bc765de-b93e-4b9b-9419-38462cabd3e8"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-6a8da34f-c177-4734-9296-60012cc53022">
      <hm-uview-text font-size="12px" text="第二步 比赛" :text-align="'left'" class="ele-6a8da34f-c177-4734-9296-60012cc53022"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-7d3df9ae-0d2a-4b45-b228-d0b656c92814">
      <hm-uview-text font-size="12px" text="" :text-align="'left'" class="ele-7d3df9ae-0d2a-4b45-b228-d0b656c92814"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-a4e33194-afbc-45e7-bcc8-ddbcf26c79ec">
      <hm-uview-text font-size="12px" text="-- 户外/跑步机皆可。" :text-align="'left'" class="ele-a4e33194-afbc-45e7-bcc8-ddbcf26c79ec"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-31fd4b60-ff13-4aae-8696-7a49451ada65">
      <hm-uview-text font-size="12px" text="第三步 完赛" class="ele-31fd4b60-ff13-4aae-8696-7a49451ada65"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-53f33209-47f4-4d7b-950c-d746bca5fc54">
      <hm-uview-text font-size="12px" text="奖牌及奖牌配件/周边将在完赛后 30 个工作日内发货；" class="ele-53f33209-47f4-4d7b-950c-d746bca5fc54"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-30657b3a-defb-4229-91e7-6326e04c3af2">
      <hm-uview-text color="#E60000" font-size="12px" text="请注意！！若未完赛，则奖牌将无法发出，但配件/周边仍可以在活动结束后发货；（30 个工作日从完赛后第一个工作日开始计算）" :text-align="'left'" class="ele-30657b3a-defb-4229-91e7-6326e04c3af2"> 
      ...
      <hm-uview-popup ref="viewPopup" v-model:show="viewPopup.show" width="80%" height="220px" border-radius="8px" :closeable="false" class="ele-viewPopup"> 
      ...
      <information-input-box ref="viewInput" placeholder=" 请填写手机验证码" v-model:value="viewInput.value" class="ele-viewInput"> 
