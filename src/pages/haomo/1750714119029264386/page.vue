<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-bg-card ref="outsideBg" width="100%" height="100%" border-radius="0" padding="0" box-shadow-color="#00000000" background-color="#FFE8EC" class="ele-outsideBg"> 
      ...
      <hm-uview-bg-card ref="notActivity" width="100%" height="100%" border-radius="0" padding="0" box-shadow-color="#00000000" background-color="#FFE8EC" class="ele-notActivity"> 
