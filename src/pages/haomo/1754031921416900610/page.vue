<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-field ref="timeField" v-model:value="timeField.value" label="核销时间" placeholder="当前核销轮次核销时间范围" label-width="160" :label-align="'center'" maxlength="-1" icon="" right-icon="" class="ele-timeField"> 
    </hm-uview-field>
    </view> 
