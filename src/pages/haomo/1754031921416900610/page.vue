<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-modal ref="writeOffModal" v-model:visible="writeOffModal.visible" :show-title="false" :title="writeOffModal.title" confirm-color="#2979FF" :show-close-icon="false" height="120px" @onConfirm="onWriteOffModalOnConfirm"> 
      ...
      <hm-uview-text ref="writeOffText" :text="writeOffText.text" :font-size="writeOffText.fontSize" :color="writeOffText.color" :padding="writeOffText.padding" class="ele-writeOffText"> 
            ...
            <view class="ele-wrapper ele-wrapper-f6bbf80c-4ef0-4d49-acc5-3177a79d8e8a">
      <hm-uview-text text="核销后不可再次领取奖品！" font-size="14px" color="#6C6C6C" padding="0" class="ele-f6bbf80c-4ef0-4d49-acc5-3177a79d8e8a"> 
...
export default {
  ...
  if (this.registrationOrdersData.originalPickUpName != this.loopList.value[2].value) {
