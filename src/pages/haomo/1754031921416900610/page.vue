<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-modal ref="writeOffModal" v-model:visible="writeOffModal.visible" :title="writeOffModal.title" confirm-color="#2979FF" :show-close-icon="false" height="100px" @onConfirm="onWriteOffModalOnConfirm"> 
...
export default {
  ...
  "writeOffText": {
    "text": "【请寻找工作人员进行核销操作，私自核销后果自负】核销后不可再次领取奖品！",
    "fontSize": "14px",
    "color": "#6C6C6C",
    "padding": "0"
  },
  ...
  if (this.registrationOrdersData.originalPickUpName != this.loopList.value[2].value) {
    ...
    this.writeOffText.text = "【请寻找工作人员进行核销操作，私自核销后果自负】当前门店与报名登记门店不一致，需要强制核销? 核销后不可再次领取奖品!";
  }
