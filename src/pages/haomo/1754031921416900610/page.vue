<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-modal ref="writeOffModal" v-model:visible="writeOffModal.visible" :title="writeOffModal.title" confirm-text="员工已确认" confirm-color="#2979FF" :show-close-icon="false" height="100px" @onConfirm="onWriteOffModalOnConfirm"> 
      ...
      <hm-uview-modal ref="loseModal" v-model:visible="loseModal.visible" title="核销失败！" confirm-color="#2979FF" :show-close-icon="false" height="100px"> 
...
export default {
  ...
  this.$postAction("/api/dkn/orderPickUp/add", {
    ...
    onButtonwanClick () {
	//核销门店不一致
  if (this.registrationOrdersData.originalPickUpName != this.loopList.value[3].value) {
