<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-bg-card :text-align="'center'" box-shadow-color="#00000000"> 
            <view class="ele-wrapper ele-wrapper-writeOffText">
      <hm-uview-text ref="writeOffText" :text="writeOffText.text" :font-size="writeOffText.fontSize" :color="writeOffText.color" class="ele-writeOffText"> 
