<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-bg-card width="100%" height="100%" border-radius="" padding="10" box-shadow-v-shadow="" box-shadow-blur="" background-color="#FAFAFA" class="ele-d2f3fb59-dd6f-46a0-9ab7-5a867871dbd7"> 
