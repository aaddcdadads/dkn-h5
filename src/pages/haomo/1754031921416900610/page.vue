  ...
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-field value="" label="活动名称" placeholder="活动名称" label-width="160" :label-align="'center'" icon="" right-icon="" class="ele-8270ddf0-7ca3-412d-a1a2-6ede8337634c"> 
            ...
            <view class="ele-wrapper ele-wrapper-67851d6a-a953-4180-ab12-882950317850">
      <hm-loop :value='[{}]' class="ele-67851d6a-a953-4180-ab12-882950317850"> 
      <template #default="{item}">
              <view class="ele-wrapper ele-wrapper-2c2f7612-a920-4eb2-b335-bac609ea5b90">
