<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-modal ref="writeOffModal" v-model:visible="writeOffModal.visible" :show-title="false" :title="writeOffModal.title" confirm-color="#2979FF" :show-close-icon="false" height="80px" @onConfirm="onWriteOffModalOnConfirm"> 
