<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-loop :value='[{"label":"姓名/昵称","value":""},{"label":"手机号码","value":""},{"label":"领奖门店","value":""}]' class="ele-3d5cca18-be80-4c03-83e5-d43ea90a2db3"> 
      <template #default="{item}">
              <view class="ele-wrapper ele-wrapper-0ded82e1-3f32-400b-915d-b361c39f83db">
      <hm-uview-field value="" :label="item.label" placeholder="" label-width="160" :label-align="'center'" icon="" right-icon="" class="ele-0ded82e1-3f32-400b-915d-b361c39f83db"> 
    </hm-uview-field>
    </view> 
          </template> 
    </hm-loop>
      ...
      <hm-loop :value='[{"src":""},{"src":""},{"src":""},{"src":""}]' class="ele-315c9068-5a40-4c3b-9b6d-3841b926c816"> 
      <template #default="{item}">
              <view class="ele-wrapper ele-wrapper-fbf844c5-828e-4650-bab4-24aeaffae8ca">
      <hm-uview-image width="80px" height="80px" class="ele-fbf844c5-828e-4650-bab4-24aeaffae8ca"> 
      ...
      <hm-uview-modal ref="kaohe" v-model:visible="kaohe.visible" title="强制核销？" confirm-color="#2979FF" :show-close-icon="false" height="80px"> 
      ...
      <hm-uview-text text="当前门店与报名登记门店不一致，需要强制核销？核销后不可再次领取奖品！" font-size="14px" color="#6C6C6C" class="ele-ac98e48c-05a4-4736-bcc2-9a8d99ceb35a"> 
            ...
            <view class="ele-wrapper ele-wrapper-010f6de0-1635-4e55-81bb-8d3ff0846e27">
      <hm-uview-bg-card width="100%" height="100%" border-radius="" box-shadow-v-shadow="" box-shadow-blur="" background-color="#FAFAFA" class="ele-010f6de0-1635-4e55-81bb-8d3ff0846e27"> 
            <view class="ele-wrapper ele-wrapper-6f70c0fe-9613-40e4-b95a-888ee2363e0f">
      <hm-uview-button :shape="'circle'" text="确认核销" @click="onEle6F70C0Fe961340E4B95A888Ee2363E0FClick" class="ele-6f70c0fe-9613-40e4-b95a-888ee2363e0f"> 
