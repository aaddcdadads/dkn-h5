<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <information-input-box ref="storeInput" v-model:value="storeInput.value" :left-src="storeInput.leftSrc" :show-code="false" :show-icon="true" placeholder="* 请选择领奖门店" @rightIcon="onStoreInputRightIcon" class="ele-storeInput"> 
