<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <information-input-box ref="storeInput" v-model:value="storeInput.value" :disabled="true" :left-src="storeInput.leftSrc" :show-code="false" :show-icon="true" placeholder="* 请选择领奖门店" @rightIcon="onStoreInputRightIcon" class="ele-storeInput"> 
      ...
      <store-selection ref="storeList" :list="storeList.list" class="ele-storeList"> 
