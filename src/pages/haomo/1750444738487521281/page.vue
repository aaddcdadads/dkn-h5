<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-text text="选择奖品套餐" font-size="16px" :text-style='{}' class="ele-a9b61974-4b4c-4f4b-bf36-c799e54a8505"> 
      ...
      <hm-uview-text text="填写资料信息" font-size="16px" :text-style='{}' class="ele-41e260d8-66e3-4a5a-8600-e82cd01f5d1c"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-nameInput">
      <information-input-box ref="nameInput" v-model:value="nameInput.value" :left-src="nameInput.leftSrc" :show-code="false" placeholder="* 姓名/昵称" class="ele-nameInput"> 
      ...
      <hm-uview-text text="参与人员信息填写" font-size="16px" :text-style='{}' class="ele-fc61ffbc-5000-4008-be66-490d31c2dc31"> 
      ...
      <registration-form-package-components ref="placeholder" :list="placeholder.list" class="ele-placeholder"> 
      ...
      <hm-uview-text text="选择门店" font-size="16px" :text-style='{}' class="ele-9fb51c90-145e-4b04-a74d-99794d96d8b3"> 
      ...
      <hm-uview-text ref="activityText" :text="activityText.text" :font-size="activityText.fontSize" :text-style="activityText.textStyle" class="ele-activityText"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-countdown">
      <hm-uview-text ref="countdown" :text="countdown.text" :font-size="countdown.fontSize" :color="countdown.color" :text-style="countdown.textStyle" class="ele-countdown"> 
       
    </hm-uview-text>
    </view> 
            <view class="ele-wrapper ele-wrapper-prices">
      <hm-uview-text ref="prices" :text="prices.text" :text-style="prices.textStyle" class="ele-prices"> 
      ...
      <hm-uview-text text="微信" font-size="14px" :text-style='{}'> 
      ...
      <hm-uview-radio ref="weixinRadio" v-model:value="weixinRadio.value" title="" :params="weixinRadio.params" :data-map="weixinRadio.dataMap" :list="weixinRadio.list" active-color="#22C386" @radioChange="onWeixinRadioRadioChange"> 
      ...
      <hm-uview-text text="支付宝" font-size="14px" :text-style='{}'> 
      ...
      <hm-uview-radio ref="zhifubaoRadio" v-model:value="zhifubaoRadio.value" title="" :params="zhifubaoRadio.params" :data-map="zhifubaoRadio.dataMap" :list="zhifubaoRadio.list" active-color="#22C386" @radioChange="onZhifubaoRadioRadioChange"> 
      ...
      <hm-uview-button :type="'primary'" :shape="'circle'" text="确认支付" :custom-style='{}' @click="onElecc32D6578Fd941629086B69B68Cf0BddClick" class="ele-cc32d657-8fd9-4162-9086-b69b68cf0bdd"> 
      ...
      <hm-uview-button ref="payButton" :shape="payButton.shape" :text="payButton.text" :custom-style="payButton.customStyle" @click="onPayButtonClick" class="ele-payButton"> 
    ...
    "list": [
      {
        ...
        "funcList": [
          {
            "value": "",
            "leftSrc1": "https://hm-static-img.oss-cn-beijing.aliyuncs.com/DecathlonSpringFestivalActivities/touxiang.png",
