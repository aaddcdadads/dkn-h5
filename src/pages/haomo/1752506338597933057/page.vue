<template>
  <view class="page card">
    <view class="page-wrapper">
      ...
      <hm-uview-bg-card width="100%" height="" border-radius="0" border-color="#FFFFFF00" padding="0" box-shadow-color="#00000000" background-color="#FFFFFF00" class="ele-e006ab79-f3a9-492b-8632-73042a091b41"> 
            <view class="ele-wrapper ele-wrapper-sharingImage">
      <hm-uview-bg-card ref="sharingImage" :width="sharingImage.width" :height="sharingImage.height" :border-radius="sharingImage.borderRadius" :padding="sharingImage.padding" :box-shadow-v-shadow="sharingImage.boxShadowVShadow" :box-shadow-blur="sharingImage.boxShadowBlur" :box-shadow-color="sharingImage.boxShadowColor" :background-image="sharingImage.backgroundImage" class="ele-sharingImage"> 
            <view class="ele-wrapper ele-wrapper-code">
      <hm-uview-icon ref="code" :name="code.name" :size="code.size" :label="code.label" class="ele-code"> 
      ...
      <hm-uview-bg-card width="100%" height="" border-radius="0" box-shadow-color="#0000000A" class="ele-084fc45c-3b7d-42af-9042-8c47c465787c"> 
      ...
      <hm-uview-bg-card ref="downloadImage" width="100%" height="100%" border-radius="0" padding="0" box-shadow-v-shadow="0" box-shadow-blur="0" box-shadow-color="#00000000" background-image="/static/components/img/save.png" @bgClick="onDownloadImageBgClick" class="ele-downloadImage"> 
    </hm-uview-bg-card>
    </view> 
...
export default {
  ...
  self.getQrCode = async function() {
    ...
    const qr = this.$qrcode(qrCodeDiv, {
      text: qrUrl,
      width: 128,
      height: 128,
    });
  ...
  const elementToCapture = document.querySelectorAll(".ele-sharingImage")[0];
